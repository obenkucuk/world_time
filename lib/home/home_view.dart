...
import 'package:world_time/selected_country/selected_country_view.dart';
...
class _HomeViewState extends State<HomeView> {
    ...
    return MultiBlocProvider(
      ...
      child: Scaffold(
        body: Stack(
          children: [
            homeBody(context),
            appBar(context, hintText, intTime, goodMorning, goodDays, theme, hourAndMinute, calendar)
          ],
        ),
      ),
    );
  ...
  SizedBox appBar(BuildContext context, String hintText, int intTime, String goodMorning, String goodDays,
      ThemeCubit theme, String hourAndMinute, String calendar) {
    return SizedBox(
      height: 300,
      child: Stack(
        children: [
